<template>
  <div style="display: inline;overflow: hidden">
    <el-popover ref="logs" v-model="showLog" title="入库批次" width="600" trigger="click"
                placement="left-end">
      <el-table :data="list" :height="total>paging.pageSize?height-30:height" style="margin: 0">
        ...
        <el-table-column prop="inQuantity" width="100" label="数量"></el-table-column>
        <go-date-time-column prop="inTime" label="入库时间" type="datetime"></go-date-time-column>
