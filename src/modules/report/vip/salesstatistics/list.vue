  ...
  <el-container>
    <el-header class="oms-search" height="35px">
      <el-form ref="filterForm" :model="filter" @keyup.enter.native="clickSearch" :rules="rules">
        <el-row :gutter="10">
          ...
          <el-col :span="6">
            <el-form-item label="日期" prop="timeBegin" >
              <go-date-picker valueFormat="yyyy-MM-dd HH:mm:ss" v-model="filter.timeBegin"></go-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="到" prop="createTimeEnd" >
              <go-date-picker valueFormat="yyyy-MM-dd HH:mm:ss" v-model="filter.timeEnd"></go-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-main v-resize="mainHeight">
      <el-table :data="list" :height="mainHeight">
        ...
        <go-quantity-column label="销售总数量" prop="salesQuantity" width="100"></go-quantity-column>
        <go-money-column label="销售总金额" prop="salesAmount" width="100px"></go-money-column>
        <go-quantity-column label="退货数量" prop="returnQuantity" width="100px"></go-quantity-column>
...
<script>
  ...
  import {ReportVipSalesStatisticsApi} from '@/modules/report/api';
  ...
  export default {
    ...
    data() {
      return {
        api: ReportVipSalesStatisticsApi,
        rules: {
