  ...
  <el-container>
    ...
    <el-main v-resize="mainHeight">
      <el-table :data="list" :height="mainHeight">
        ...
        <go-money-column label="销量退货率(%)" prop="returnQuantityRatio" width="100px"></go-money-column>
...
<script>
  ...
  import {ReportB2CSellAndReturnStatisticsApi} from '@/modules/report/api';
  ...
  export default {
    ...
    data() {
      return {
        api: ReportB2CSellAndReturnStatisticsApi,
        rules: {
