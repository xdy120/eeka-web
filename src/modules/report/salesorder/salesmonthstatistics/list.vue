      ...
      <el-form ref="filterForm" :model="filter" @keyup.enter.native="clickSearch" :rules="rules">
        <el-row :gutter="10">
          ...
          <div v-show="filter.statisticsType ==='year'">
            <el-col :span="6">
              <el-form-item label="起始年" prop="createTimeBegin">
                <el-date-picker v-model="filter.createTimeBegin" type="year" placeholder="按制单时间"
                                value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="终止年" prop="createTimeBegin">
                <el-date-picker v-model="filter.createTimeEnd" type="year" placeholder="按制单时间"
                                value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
              </el-form-item>
            </el-col>
          </div>
          <div v-show="filter.statisticsType ==='month'">
            <el-col :span="6">
              <el-form-item label="起始月" prop="createTimeBegin">
                  <el-date-picker v-model="filter.createTimeBegin" type="month" placeholder="按制单时间"
                                value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="终止月" prop="createTimeBegin">
                <el-date-picker v-model="filter.createTimeEnd" type="month" placeholder="按制单时间"
                                value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
              </el-form-item>
            </el-col>
          </div>
...
<script>
  ...
  import {ReportSalesOrderMonthtatisticsApi} from '@/modules/report/api';
  ...
  export default {
    ...
    data() {
      return {
        api: ReportSalesOrderMonthtatisticsApi,
    ...
    methods: {
      searchValidate() {
        this.$refs.filterForm.validate().then(() => {
          ReportSalesOrderMonthtatisticsApi.list(this.filter, this.paging).then(res => {
            this.restColumn();
