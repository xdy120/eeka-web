<template>
  <el-container>
    ...
    <el-header class="oms-action" height="35px">
      ...
      <el-button @click="exportReturnDetail">导出</el-button>
    </el-header>
    <el-main v-resize="mainHeight">
      <el-table :data="list" :height="mainHeight">
        <el-table-column type="index" width="50" label="序号"></el-table-column>
        <el-table-column label="店铺名称" prop="storeName" width="200"></el-table-column>
        <el-table-column label="退货单号" prop="returnOrderCode" width="150"></el-table-column>
...
<script>
  ...
  import {ReportReturnDetailApi} from '@/modules/report/api';
