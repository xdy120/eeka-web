  ...
  <el-container>
    <el-header class="oms-search" height="70px">
      <el-form :model="filter" @keyup.enter.native="clickSearch" label-width="85px">
        <el-row :gutter="10">
          ...
          <el-col :span="6">
            <el-form-item label="平台退款单">
              <el-input v-model="filter.refundId"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
    ...
    <el-main v-resize="mainHeight">
      <el-table :data="logs" :height="mainHeight">
        ...
        <el-table-column label="平台退款单" prop="_source.refundId" width="150px"></el-table-column>
  ...
  export default {
    ...
    methods: {
      buildFilter(query) {
        ...
        if (this.filter.refundId) {
          query.push({match: {'refundId': this.filter.refundId}});
        }
