<template>
  <el-dialog title="入库单创建" :visible.sync="visible" :before-close="dialogCloseConfirm"
             width="1000px">
    ...
    <el-container v-show="stepTitle==='入库明细'">
      ...
      <el-main>
        <el-table :height="300" :data="domain.details" style="margin-top: 5px" show-summary>
          ...
          <go-quantity-column prop="noticeQuantity" label="通知数量" width="90px" sortable>
...
<script>
  ...
  import {MustColumns, SkuColumns, StockInApi} from './api';
