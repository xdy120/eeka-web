      ...
      <el-col :span="8">
        <el-form-item label="采购日期">
          <div class="block">
            ...
            <go-date-picker v-model="filter.purchaseDateBegin"></go-date-picker>
          </div>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="至">
          <div class="block">
            <span class="demonstration"></span>
            <go-date-picker v-model="filter.purchaseDateEnd"></go-date-picker>
          </div>
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="10">
      <el-col :span="8">
        <el-form-item label="到货日期">
          <div class="block">
            <span class="demonstration"></span>
            <go-date-picker v-model="filter.arrivalDateBegin"></go-date-picker>
          </div>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="至">
          <div class="block">
            <span class="demonstration"></span>
            <go-date-picker v-model="filter.arrivalDateEnd"></go-date-picker>
          </div>
        </el-form-item>
      </el-col>
    </el-row>
